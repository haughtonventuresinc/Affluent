      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 mb-16">
                ...
                <div key={index} className="group bg-white/90 backdrop-blur-sm rounded-xl p-6 hover:bg-gray-100/90 transition-all duration-300 transform hover:scale-105">
                  <div className="flex space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 text-sm mb-3 leading-relaxed">{book.description}</p>
                      ...
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-4">
                          ...
                          <div className="flex items-center space-x-1">
                            ...
                            <span className="text-sm text-gray-600">{book.members.toLocaleString()}</span>
                          </div>
                        </div>
                        <button className="text-gray-900 font-semibold text-sm hover:text-gray-700 transition-colors">
                          Join Discussion →
                        </button>
                      </div>
                    </div>
          ...
          <div>
                ...
                <div key={index} className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 hover:from-gray-100 hover:to-gray-200 transition-all duration-300">
                  <div className="flex items-center space-x-4">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-gray-600 mb-1">{event.book}</p>
                      <p className="text-sm text-gray-500">{event.time}</p>
                    </div>
                    <button className="bg-gray-900 text-white px-4 py-2 rounded-lg text-sm font-semibold hover:bg-gray-800 transition-all duration-300 transform hover:scale-105">
                      RSVP
                    </button>
                  </div>
                </div>
            ...
            <div className="mt-8 bg-gradient-to-r from-gray-900 to-gray-700 rounded-xl p-6 text-white">
        ...
        <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-2xl p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600 text-sm">Access to author interviews and bonus materials.</p>
            </div>
          </div>
        </div>
      </div>
