...
const Hero = () => {
  ...
  return (
    <section id="hero" className="relative min-h-screen bg-black flex items-center">
      ...
      <div className="relative max-w-7xl mx-auto px-4 pt-16 sm:px-6 lg:px-8 text-center">
        <div className="flex justify-center mb-8">
            <div className="backdrop-blur-sm rounded-xl px-6 py-3 hidden md:block">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center">
          <button 
            ...
            className="bg-white text-black px-8 py-4 rounded-full text-lg font-semibold transition-all duration-300 transform hover:scale-105 flex items-center justify-center space-x-2"
          >
